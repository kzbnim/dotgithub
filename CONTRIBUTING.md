...
All members of the project community must abide by the [Code of Conduct](https://github.com/minbzk/.github/blob/main/CODE_OF_CONDUCT.md).
...
* If you plan to do something more involved, please reach out to us by opening an issue first. This will avoid unnecessary work and surely give you and us a good deal of inspiration.
...
You are welcome to contribute code or documentation. Please read and sign the [Contributer License Agreement (CLA)](https://github.com/minbzk/.github/blob/main/CLA.md) before contributing. 
...
-- 
_Credits: this document is based on the document by the `minvws` Github organization, the official COVID-19 exposure notification app for Germany  <https://github.com/corona-warn-app/>, the Apache Software Foundation and the Debian Code of Conduct, Version 1.0 ratified on April 
28th, 2014._ 
